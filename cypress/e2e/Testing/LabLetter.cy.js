...
const url =
  "http://localhost/2023/2223II_INT3306_20-Letter_N2-132927/Nguy%e1%bb%85n%20Quang%20Minh_691580_assignsubmission_file_20020146_Nguyen%20Quang%20Minh_Letter_N2/20020146_Nguyen%20Quang%20Minh_Letter_N2.html";
...
describe("Lab Letter", () => {
  ...
  context("Block/structural semantics", () => {
    ...
    it("Heading organization", { defaultCommandTimeout: 200 }, () => {
      cy.get("h1").should("contain", "Re: Eileen Dover university application");
  ...
  context("Inline semantics", () => {
    ...
    it("Hyperlink", { defaultCommandTimeout: 200 }, () => {
      ...
      links.forEach((item, index) => {
        cy.get("a").eq(index).should("contain", item).and("have.attr", "href");
      });
    });
